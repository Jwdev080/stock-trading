                                ...
                                <div className="header__left">
                                    <div className="logo">
                                        <Link className="light" href="/">
                                            <img src="/assets/images/logo/logo.png" alt="" width={70} height={70} data-retina="assets/images/logo/logo@2x.png" data-width={118} data-height={32} />
                                        </Link>
                                        <Link className="dark" href="/">
                                            <img src="/assets/images/logo/logo-dark.png" alt="" width={70} height={70} data-retina="assets/images/logo/logo-dark.png" data-width={118} data-height={32} />
                                        </Link>
                                    </div>
                                ...
                                <div className="header__right">
                                    ...
                                    <Menu as="div" className="dropdown user">
                                        ...
                                        <Menu.Items as="div" className="dropdown-menu show" aria-labelledby="dropdownMenuButton4">
                                            ...
                                            <Link className="dropdown-item" href="/wallet"><i className="bx bx-wallet font-size-16 align-middle me-1" />
